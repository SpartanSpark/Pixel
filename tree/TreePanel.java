...
public class TreePanel extends JPanel{
	...
	public boolean pop;
	public String extended, path, settings, test, pathFi, userDir, seperate;
	...
	public void setup() {
		...
		if((new File(path)).mkdir()) {
			...
			try {
				File themeFile = new File(userDir + seperate + "themes" + seperate + "dev.pxt");
				...
				bw.write("30,30,30,this is background color\r\n" + 
						...
						"175,95,175,this is punctuation color\r\n" + 
